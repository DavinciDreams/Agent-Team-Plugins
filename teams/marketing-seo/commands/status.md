---
description: Show marketing-seo team status and recent activity
argument-hint: [verbose]
---

# Marketing SEO Team Status

**Actions**:

1. Read `team.json` from the plugin root to display team composition
2. Check for the team log file at `~/.claude/team-logs/marketing-seo.jsonl`
