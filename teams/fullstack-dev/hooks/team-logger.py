#!/usr/bin/env python3
"""Full-stack dev team telemetry logger - appends tool usage events to JSONL.

Reads PostToolUse hook data from stdin, writes structured events to:
  ~/.claude/team-logs/fullstack-dev.jsonl

Each line is a JSON object:
  {"ts": "ISO8601", "tool": "Write", "file": "src/App.tsx", "team": "fullstack-dev", "status": "ok"}
"""
